<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MainCounties.aspx.cs" Inherits="HavocNet.Web.MainCounties" MasterPageFile="~/Summits/Summits.master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function InitMap() {
            var myOptions = {
                center: new google.maps.LatLng(52.84259, -1.42822),
                zoom: 7,
            ...
            map.controls[google.maps.ControlPosition.TOP_CENTER].push(InitMenu(map, 'Counties'));
        }
