<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SuDokuChain.aspx.cs" Inherits="HavocNet.Web.Puzzles.SuDokuPolyPage" MasterPageFile="~/HavocNet.master" %>
        ...
        <table>
            <tr>
                ...
                <td style="padding: 3px 0 0 10px" valign="top">
                    ...
                    <p>
                        To demarkate the separate boxes for the chain Su-Doku, select a colour, place the cursor in each of the cells that correspond to that colour chain and press the enter key.
                    </p>
                    <p>
