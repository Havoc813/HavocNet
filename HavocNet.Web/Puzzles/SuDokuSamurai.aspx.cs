...
{
    public partial class SuDokuSamuraiPage : Page
    {
        ...
        {
            var aSuDoku = new SuDokuSamurai(new int[21, 21]);
            this.phPuzzle.Controls.Add(aSuDoku.Render());
        }

        private void cmdDemo_Click(object sender, ImageClickEventArgs e)
        {
            var aDemo = new SamuraiDemo();
            var aSuDoku = new SuDokuSamurai(aDemo.DemoConditions, "demo");
        ...
        {
            var aSuDoku = new SuDokuSamurai(SuDoku.MakeInitialConditions(21), "solved");
            aSuDoku.Solve();
