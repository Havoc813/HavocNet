...
{
    public partial class MenuCaptureMatch : Page
    {
        ...
        private void BindControls()
        {
            ...
            var ctrls = new AthleticaControls(_myMaster.aUser, aServer, _myMaster.SelectedSport, "Match");
            ...
            AthleticaControls.BindTextBoxes(new[] { this.txtComment, this.txtWon, this.txtLost });
        ...
        private void cmdUpload_Click(object sender, ImageClickEventArgs e)
        {
            ...
            var repository = new MatchRepository(aServer);
            ...
            repository.Create(
                ...
                int.Parse(Request["ctl00$cphMain$txtWon"]),
                int.Parse(Request["ctl00$cphMain$txtLost"])
                );
        }
    }
}