<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MenuCaptureMatch.aspx.cs" Inherits="HavocNet.Web.Athletica.MenuCaptureMatch" MasterPageFile="Athletica.master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" runat="Server">
    ...
    <script type="text/javascript">
        function OnBeforeSubmit() {
            ...
            if (!ValidateNumber("ctl00_cphMain_txtWon", "Number of games")) { return false; }
            if (!ValidateNumber("ctl00_cphMain_txtLost", "Number of games")) { return false; }
            ...
            <tr>
                <td style="width:50%; vertical-align: top">
                    <table>
                        ...
                        <tr><td><div class="CaptureHeader">Location</div></td></tr>
                        <tr>
                            <td>
                                <table>
                                    <tr>
                        ...
                        <tr><td><div class="CaptureHeader">Score</div></td></tr>
                        <tr>
                            <td>
                                Games Won <asp:TextBox runat="server" ID="txtWon" Width="25px"></asp:TextBox> and Lost <asp:TextBox runat="server" ID="txtLost" Width="25px"></asp:TextBox>
                            </td>
                        </tr>
                    </table>
                </td>
